...
if __name__ == "__main__":
    ...
    # 1. Read FITS image file
    # 2. Set up global variables
    # 3. Read APASS source catalogue
    ...
    AL.button_test()
    pylab.show()
    AL.browse_APASS_subimages(FITSdata, APASS_table, Npx, filename=inputFile.split('/')[-1])
