...
if __name__ == "__main__":
	...
	for k in range(0,len(run_entries)):
	  ...
	  #print k, n, num
	  #print '\nimage_%s %s'%(num,filename_table['filename'][n])
	  print './quadPhot.py -i %s -e 1 -o /disk4/romerowo/lcolens_outputs/20151028/image_%s > /disk4/romerowo/lcolens_outputs/20151028/run_%s.log'%(filename_table['filename'][n], num, num)
